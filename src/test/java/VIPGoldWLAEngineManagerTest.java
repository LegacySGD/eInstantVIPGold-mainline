...
public class VIPGoldWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(VIPGoldWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/VIPGoldIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/VIPGoldIW/InitOutcome.xml").getDocumentElement();
